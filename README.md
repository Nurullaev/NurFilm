...
Требуется Android 8.0 или новее, размер — около 3 МБ. Приложение обновляется само: установить файл нужно один раз.
...
- **Поиск** — по названию на русском и английском, в том числе **голосом** (на телевизоре — микрофоном пульта)
