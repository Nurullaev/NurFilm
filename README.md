...
1. Откройте на телефоне [nurfilm-latest.apk](https://nurfilm.app/app/nurfilm-latest.apk) и скачайте файл.
...
- **С флешки:** скопируйте APK на флешку, вставьте её в телевизор и откройте файл через файловый менеджер.
- **Через Downloader:** установите на телевизор приложение Downloader и введите в нём ссылку `https://nurfilm.app/app/nurfilm-latest.apk`.
